...
import com.koxx4.simpleworkout.simpleworkoutserver.data.AppUserAuthenticationTokenDto;
...
public interface UserService {
    ...
    AppUserAuthenticationTokenDto getAppUserAuthDtoByJwtToken(String jwtToken);
}
